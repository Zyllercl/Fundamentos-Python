'''
    ...
    Def:
        - Crear un programa para convertir una calificación númerica entre (1.0 y 7.0) a una letra. Considerar las siguientes condiciones:
            1.- Si la nota es igual a 1.0 y menor o igual 3.9               -> Letra F
